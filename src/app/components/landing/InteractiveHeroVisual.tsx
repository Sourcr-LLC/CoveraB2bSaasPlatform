...
function DashboardContent() {
  ...
  return (
    <div className="flex h-[600px] md:h-[700px] bg-[#fafaf9]">
      ...
      {/* SIDEBAR */}
      <div className="hidden md:flex landscape:flex w-56 md:w-64 flex-col bg-[#3A4F6A] border-r border-white/10 flex-shrink-0">
        <div className="h-16 flex items-center px-4 md:px-6 border-b border-white/10">
           {/* LOGO */}
           <svg width="100" height="22" viewBox="0 0 800 168" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white md:w-[110px] md:h-[24px]">
        ...
        <div className="mt-auto p-3 md:p-4 border-t border-white/10">
