...
function DashboardContent() {
  ...
  return (
    <div className="flex h-[600px] md:h-[700px] bg-[#fafaf9]">
      ...
      {/* SIDEBAR */}
      <div className="hidden md:flex w-64 flex-col bg-white border-r border-[#e7e5e4]">
        <div className="h-16 flex items-center px-6 border-b border-[#f5f5f4]">
           {/* LOGO */}
        ...
        <div className="mt-auto p-4 border-t border-[#e7e5e4]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* HEADER */}
        <div className="h-16 border-b border-[#e7e5e4] bg-white flex items-center justify-between px-6 md:px-8">
...
function VendorRow({ name, type, status, date }: any) {
  ...
  return (
    <div className="px-6 py-4 flex items-center justify-between group hover:bg-[#fafaf9] transition-colors relative overflow-hidden">
       <div className="flex items-center gap-4 relative z-10">
         <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-500 ${status === "Verified" ? "bg-emerald-100 text-emerald-600" : "bg-[#f5f5f4] text-slate-500"}`}>
