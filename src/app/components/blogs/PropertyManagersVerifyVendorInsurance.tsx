  ...
  return (
    <div className="page-root min-h-screen flex flex-col bg-[#fafaf9]">
      ...
      <main className="flex-1">
        <article className="section section-padding pt-32 pb-20 md:pt-48">
          <div className="w-full max-w-3xl mx-auto">
            ...
            <h1 className="mb-6 text-[#0A0F1E] text-3xl sm:text-4xl md:text-5xl leading-tight font-semibold tracking-tight">
