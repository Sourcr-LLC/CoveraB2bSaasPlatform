...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Generate initials from user name - memoized
  ...
  // Show paywall if not premium and trying to access premium routes
          ...
          <nav className="flex-1 px-4 py-8 space-y-1 overflow-y-auto">
            {navigation.map((item) => {
              ...
              return (
                <div
                  key={item.name}
                  className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm opacity-50 cursor-not-allowed"
                  style={{
            ...
            {/* Settings & Billing accessible - integrated in navigation */}
            <Link
              to="/billing"
            ...
            <div className="max-w-2xl w-full">
              ...
              >
                ...
                <button
                  ...
                  className="px-8 py-4 rounded-lg text-base transition-all inline-flex items-center gap-2 mb-6"
                  style={{ 
                    backgroundColor: 'var(--primary)',
                    color: 'var(--primary-foreground)',
                    fontWeight: 500,
                ...
                <div className="text-sm" style={{ color: 'var(--foreground-subtle)' }}>
                  Try Covera free for 7 days — no charge until your trial ends
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {[
                  ...
                  return (
                    ...
                    >
                      <Icon className="w-6 h-6 mb-3" style={{ color: 'var(--primary)' }} />
                      <h3 className="text-sm mb-1" style={{ fontWeight: 600, color: 'var(--foreground)' }}>
                        {feature.title}
                      </h3>
  ...
  return (
    <div className="flex h-screen" style={{ backgroundColor: 'var(--background)' }}>
      ...
      {/* Mobile Menu */}
      <aside 
        className={`fixed top-0 left-0 h-screen w-64 border-r flex flex-col ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300`}
        style={{ 
          backgroundColor: 'var(--card)',
          borderColor: 'var(--border)'
        }}
      ...
      <main className="flex-1 overflow-y-auto flex flex-col">
        {/* Top Header Bar */}
        <div 
          className="h-20 border-b flex items-center justify-end px-8"
          style={{ 
