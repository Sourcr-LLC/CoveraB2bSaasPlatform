    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-[#0A0F1E] mb-8">Featured Articles</h2>
              ...
              >
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="px-3 py-1 bg-[#3A4F6A]/10 text-[#3A4F6A] rounded-full text-xs font-medium">
                      {post.category}
                    </span>
                  </div>
                  <h3 className="text-xl font-bold text-[#0A0F1E] mb-3 group-hover:text-[#3A4F6A] transition-colors">
                    {post.title}
                  </h3>
          ...
          {/* All Articles */}
          <h2 className="text-2xl font-bold text-[#0A0F1E] mb-8">All Articles</h2>
          <div className="space-y-6">
            {regularPosts.map((post) => (
              <Link
                key={post.slug}
                to={`/blog/${post.slug}`}
                className="group flex items-start gap-6 p-6 bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300"
              >
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-bold text-[#0A0F1E] mb-2 group-hover:text-[#3A4F6A] transition-colors">
                    {post.title}
                  </h3>
                ...
                <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-[#3A4F6A] group-hover:translate-x-1 transition-all flex-shrink-0 mt-2" />
              </Link>
            ))}
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 border-t" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--panel)' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-[#0A0F1E]">
