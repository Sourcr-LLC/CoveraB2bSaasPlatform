...
export default function AboutUs() {
  ...
  return (
    <div className="page-root min-h-screen flex flex-col bg-[#fafaf9] text-[#1a1a1a] selection:bg-[var(--primary)] selection:text-white">
      <SEO
      ...
      <main className="flex-1">
        ...
        {/* Introduction */}
        <section className="section section-padding py-20 bg-white/50 border-y border-slate-100">
        ...
        {/* Why We Exist */}
        <section className="section section-padding py-24">
          <div className="w-full">
            <div className="grid md:grid-cols-12 gap-12">
              <div className="md:col-span-5">
                ...
                <p className="text-2xl font-medium text-[var(--primary)]">
        ...
        {/* What We Do */}
        <section className="section section-padding py-24 bg-white border-y border-slate-100">
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 rounded-2xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-lg transition-all">
