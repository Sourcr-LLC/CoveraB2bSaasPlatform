...
export default function LandingNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-xl border-b border-white/40 transition-all duration-300 supports-[backdrop-filter]:bg-white/50">
      <div className="w-full mx-auto px-6 md:px-8">
        <div className="h-16 md:h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center" aria-label="Covera Home">
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-6">
              <Link to="/about-us" className="text-sm font-medium text-slate-600 hover:text-[#3A4F6A] transition-colors">About</Link>
              <div 
              ...
              >
                <button 
                  className="text-sm font-medium text-slate-600 hover:text-[#3A4F6A] transition-colors flex items-center gap-1 group-hover:text-[#3A4F6A]"
                >
                  Industries
            ...
            <div className="flex items-center gap-6">
              ...
              <Link 
                to="/login" 
                className="px-5 py-2.5 rounded-xl text-sm font-medium bg-[#3A4F6A] text-white hover:bg-[#2c3e53] transition-all shadow-lg shadow-[#3A4F6A]/20 hover:shadow-[#3A4F6A]/30 hover:-translate-y-0.5"
              >
                Launch App
              </Link>
            </div>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <Link to="/login" className="w-full py-3 rounded-xl text-sm font-medium bg-[#3A4F6A] text-white text-center">Launch App</Link>
        </div>
      </div>
    </nav>
  );
