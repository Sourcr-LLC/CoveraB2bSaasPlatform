...
export default function DesktopSidebar({ organizationName, userEmail, userInitials, logoUrl }: DesktopSidebarProps) {
  ...
  return (
    <>
      ...
      {isLoggingOut && (
        ...
        >
          <div className="flex flex-col items-center gap-4">
            <Loader2 className="w-12 h-12 animate-spin" strokeWidth={1} style={{ color: 'var(--primary)' }} />
      ...
      >
        {/* Logo */}
        <div className="h-20 flex items-center px-8 border-b" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
          <svg width="120" height="25" viewBox="0 0 3000 630" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
        ...
        {/* Bottom section */}
        <div className="border-t px-4 py-4 space-y-1" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
          <Link
            to="/billing"
            className="flex items-center gap-3 px-4 py-3 rounded-lg transition-all text-sm"
            style={{ 
              color: '#ffffff',
              backgroundColor: location.pathname === '/billing' ? 'rgba(255, 255, 255, 0.15)' : 'transparent'
            }}
          >
          ...
          <Link
            ...
            style={{ 
              color: '#ffffff',
              backgroundColor: location.pathname === '/settings' ? 'rgba(255, 255, 255, 0.15)' : 'transparent'
            }}
          >
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg transition-all text-sm w-full hover:bg-white/5"
            style={{ color: '#ffffff', cursor: 'pointer', backgroundColor: 'transparent', border: 'none', textAlign: 'left' }}
          >
