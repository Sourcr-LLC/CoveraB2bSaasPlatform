          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="p-5 md:p-6 rounded-2xl border hover:shadow-md transition-shadow duration-200" style={{ backgroundColor: 'var(--card)', borderColor: '#f1f5f9' }}>
                <AlertTriangle className="w-7 h-7 md:w-8 md:h-8 mb-3 md:mb-4" style={{ color: 'var(--primary)' }} />
                <h3 className="mb-2 text-base md:text-lg" style={{ fontWeight: 600 }}>Guest Safety</h3>
                <p className="text-sm leading-relaxed" style={{ color: 'var(--foreground-muted)' }}>
                  Contractors working in occupied areas without proper insurance or safety certification
                </p>
              </div>

              <div className="p-5 md:p-6 rounded-2xl border hover:shadow-md transition-shadow duration-200" style={{ backgroundColor: 'var(--card)', borderColor: '#f1f5f9' }}>
                <Clock className="w-7 h-7 md:w-8 md:h-8 mb-3 md:mb-4" style={{ color: 'var(--primary)' }} />
                <h3 className="mb-2 text-base md:text-lg" style={{ fontWeight: 600 }}>24/7 Operations</h3>
                <p className="text-sm leading-relaxed" style={{ color: 'var(--foreground-muted)' }}>
                  Round-the-clock vendor access requiring constant compliance verification and documentation
                </p>
              </div>

              <div className="p-5 md:p-6 rounded-2xl border hover:shadow-md transition-shadow duration-200" style={{ backgroundColor: 'var(--card)', borderColor: '#f1f5f9' }}>
                <Shield className="w-7 h-7 md:w-8 md:h-8 mb-3 md:mb-4" style={{ color: 'var(--primary)' }} />
                <h3 className="mb-2 text-base md:text-lg" style={{ fontWeight: 600 }}>Property Liability</h3>
                <p className="text-sm leading-relaxed" style={{ color: 'var(--foreground-muted)' }}>
                  High-value facilities and guest areas exposed to risk from non-compliant maintenance vendors
                </p>
              </div>
            </div>
          </div>
